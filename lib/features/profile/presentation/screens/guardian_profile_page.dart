...
import 'package:btcclient/features/profile/presentation/screens/edit_guardian_personal_information_screen.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  GuardianProfileCard(
                    ...
                    onEditImage: () async {
                      ...
                      try {
                        ...
                        debugPrint("❌ Guardian profile image error: $e");
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text("Unable to change profile image"),
                          ),
                        );
                      }
                    },
                  ...
                  Container(
                    ...
                    // IMPORTANT:
                    // This makes the white section fill the remaining
                    // viewport when its content is short.
        ...
        return GuardianPersonalSectionCard(
          ...
          onEdit: () async {
            ...
            final updated = await Navigator.push<bool>(
              context,
              MaterialPageRoute(
                builder: (_) => const EditGuardianPersonalInformationScreen(),
              ),
            );
