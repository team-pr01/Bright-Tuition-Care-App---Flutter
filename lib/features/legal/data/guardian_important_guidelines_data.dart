...
const ImportantGuidelinesData guardianImportantGuidelinesData =
  ...
  sections: [
    ...
    ImportantGuidelineSection(
      ...
      subsections: [
        ...
        ImportantGuidelineSubsection(
          ...
          note:
              "Communicate respectfully to ensure a positive interaction and an effective assessment of the tutor.",
        ),
      ],
    ),
    ...
    ImportantGuidelineSection(
      ...
      content: [
        "While Bright Tuition Care verifies tutor profiles for authenticity, you may also request a photocopy of the tutor’s most recent educational qualification documents for your records.",
        "Keeping this documentation is recommended for as long as the tutor continues to teach your child.",
      ],
    ),
