...
class ConfirmationLetterScreen extends ConsumerStatefulWidget {
  final String letterId;
  final String role;

  const ConfirmationLetterScreen({
    super.key,
  ...
  @override
  ConsumerState<ConfirmationLetterScreen> createState() =>
      _ConfirmationLetterScreenState();
}

class _ConfirmationLetterScreenState
    extends ConsumerState<ConfirmationLetterScreen> {
          ...
          children: [
            ...
            _buildSectionCard(
              ...
              children: [
                ...
                _infoRow(
                  "Location",
                  "${letter.job.cities.join(", ")}, "
                      "${letter.job.areas.join(", ")}",
                ),
              ],
            ),
            ...
            AppButton(
              ...
              onPressed: _isDownloadingPdf
                  ...
                  : () async {
                      ...
                      try {
                        final pdfWidget =
                            await ConfirmationLetterPdf.build(
                          letter: letter,
                        );
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      "You can sign digitally or manually download the PDF, "
                      "print it and sign with date.",
                      style: AppTextStyles.bodySmall.copyWith(
                        color: AppColors.neutrals02,
                        height: 1.4,
                      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Congratulations! Bright Tuition Care has successfully "
          ...
          Text(
            "Below is a summary of the agreed tuition details. "
            "Please review them carefully before signing the "
            "confirmation letter.",
            style: AppTextStyles.bodyMedium.copyWith(
              height: 1.6,
              color: AppColors.neutrals03,
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final notifier =
                    ref.read(confirmationProvider.notifier);
                ...
                if (success) {
                  await notifier.fetchSingleLetter(
                    widget.letterId,
                  );
